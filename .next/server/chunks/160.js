"use strict";exports.id=160,exports.ids=[160],exports.modules={9160:(e,o,t)=>{t.d(o,{Ij:()=>a,Ps:()=>getWarpById,ZP:()=>s});let a=[{id:"mihu-farm",name:"mihu-farm",status:"active",desc:"Mega farm for crops and resources - maintained regularly.",guide:`## Rules
    items: [
      { name: 'Enchanted Decree', icon: '' },
      { name: 'Tryals of Olympus', icon: '' },
      { name: 'Mistweave', icon: '' },
      { name: 'Deidara Shovel', icon: '' },
      { name: 'Void Shovel', icon: '' },
      { name: 'Whisperwood', icon: '' },
      { name: 'Atlas Axe', icon: '' },
      { name: 'Kodama', icon: '' },
      { name: 'Mystical Sickle', icon: '' },
      { name: 'Demeters Touch', icon: '' },
      { name: 'Sylvan Staff', icon: '' },
      { name: 'Shulkers', icon: '' }
    ],
...
F10 - Spruce Trees
F11 - Mob Farms
'F' as of floor`},{id:"mihu-rentals",name:"mihu-rentals",status:"active",desc:"Item rentals, mostly tools and blocks - follow posted rules.",guide:"Rentals are managed through signs. Respect expiry times and return rented items in good condition."},{id:"mihu-shop",name:"mihu-shop",status:"upcoming",desc:"Community shop + Blossom Items - opening soon with trades.",guide:"Shop will support currency and item trades. Check announcement boards for opening date."},{id:"mihu-casino",name:"mihu-casino",status:"upcoming",desc:"Mini-games, events, giveaways - fair play required.",guide:"Casino hosts events and minigames. Play fair and follow event rules; no real-money gambling."}];function getWarpById(e){return a.find(o=>o.id===e)}let s=a}};