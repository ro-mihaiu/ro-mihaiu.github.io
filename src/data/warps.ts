...
export const warps: Warp[] = [
  ...
  { id: 'mihu-money', name: 'mihu-money', status: 'upcoming', desc: 'Money island for earning and managing currency.', guide: 'MIHU MONEY GUIDE PLACEHOLDER - replace this with the money island guide.' }
]
