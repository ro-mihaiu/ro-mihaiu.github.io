...
const lifeItems = [
  {
    ...
    description: "I'm doing some giveaways, or player events."
  },
  {
...
export default function ServerLifeSection() {
  return (
    <section id="server-life" className="relative min-h-screen py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          {lifeItems.map((item, index) => (
            ...
            >
              <div className="rounded-[2rem] border border-white/10 bg-transparent p-8 shadow-xl shadow-black/15 backdrop-blur-xl h-full flex flex-col">
